...
func main() {
	...
	mux.HandleFunc("GET /api/public/appointments/current",          app.PublicCurrentAppointment)
	mux.HandleFunc("POST /api/public/appointments/{id}/checkin",    app.PublicAppointmentCheckin)
	mux.HandleFunc("POST /api/public/appointments/{id}/book-next",  app.PublicBookNext)
