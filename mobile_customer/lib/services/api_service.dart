...
class ApiService {
  ...
  static Future<dynamic> post(String path, [Map<String, dynamic>? body]) async {
    final res = await http
        .post(_uri(path), headers: _headers, body: body != null ? json.encode(body) : null)
        .timeout(const Duration(seconds: 15));
    return _decode(res);
  }
  ...
  static Future<dynamic> put(String path, Map<String, dynamic> body) async {
    final res = await http
        .put(_uri(path), headers: _headers, body: json.encode(body))
        .timeout(const Duration(seconds: 15));
    return _decode(res);
  }
  ...
  static Future<dynamic> patch(String path, [Map<String, dynamic>? body]) async {
    final res = await http
        .patch(_uri(path), headers: _headers, body: body != null ? json.encode(body) : null)
        .timeout(const Duration(seconds: 15));
    return _decode(res);
  }
